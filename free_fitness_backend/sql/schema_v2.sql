-- =============================================================================
-- Personal Health & Fitness App - Database Schema (MySQL) - V2 (Synced)
...
CREATE TABLE `ff_user` (
  ...
  `water_goal` double DEFAULT NULL COMMENT 'Daily water goal (ml)',
...
-- 动态点赞表
DROP TABLE IF EXISTS `ff_social_like`;
CREATE TABLE `ff_social_like` (
...
CREATE TABLE `ff_serving_info` (
  ...
  `water` double DEFAULT NULL COMMENT 'Water content (g or ml)',
  `contributor` varchar(64) DEFAULT NULL,
  `gmt_create` varchar(30) DEFAULT NULL,
...
CREATE TABLE `ff_daily_food_item` (
  ...
  `water` double DEFAULT NULL COMMENT 'Water intake (ml)',
  `gmt_create` varchar(30) DEFAULT NULL,
  `gmt_modified` varchar(30) DEFAULT NULL,
...
CREATE TABLE `ff_sleep_records` (
  ...
  `quality` int DEFAULT NULL COMMENT '1-100',
  `note` text,
  `gmt_create` varchar(30) NOT NULL,
...
-- AI 健康分析建议表
DROP TABLE IF EXISTS `t_health_ai_analysis`;
CREATE TABLE `t_health_ai_analysis` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL,
  `feedback` text,
  `score` int DEFAULT NULL,
  `date` varchar(12) NOT NULL COMMENT 'yyyy-MM-dd',
  `type` varchar(20) DEFAULT NULL COMMENT 'EXERCISE, SLEEP',
  `gmt_create` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
